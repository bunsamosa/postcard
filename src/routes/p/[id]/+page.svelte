<script lang="ts">
  ...
  import { stamps as allStamps } from '$lib/data/stamps';
  ...
  onMount(() => {
    ...
    if (postcard && postcard.selected_stamp_id && allStamps[postcard.selected_stamp_id - 1]) {
      stampImageUrl = allStamps[postcard.selected_stamp_id - 1].path;
    }
